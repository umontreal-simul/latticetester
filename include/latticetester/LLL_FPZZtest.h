...
long LLL_FPZZtest(mat_ZZ& B, double delta = 0.99,
	    long deep = 0, LLLCheckFct check = 0, long verbose = 0);

long LLL_FPZZtest(mat_ZZ& B, mat_ZZ& U, double delta = 0.99, long deep = 0,
...
long LLL_FPZZtest(mat_ZZ& B, double delta, long deep, LLLCheckFct check,
           long verb)
{
   verbose = verb;
   RR_GS_time = 0;
   ...
   return LLL_FPZZtest(B, 0, delta, deep, check);
}

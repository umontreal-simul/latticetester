  ...
  template<typename RealRed>
    class NormaMinkL1 : public Normalizer<RealRed> {
      public:
        ...
        /**
         * Constructor for the Marsagliaâ€™s bounds with the
         ...
         */
        NormaMinkL1 (RealRed & logDensity, int t, double beta = 1);
      ...
      private:
        ...
        /**
         * The lattice constants \f$\gamma_j\f$ are the Marsagliaâ€™s bounds in each
         * dimension \f$j\f$.
         */
        double *m_gamma;

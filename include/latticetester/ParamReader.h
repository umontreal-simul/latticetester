  ...
  template<typename Int, typename RealRed>
    class ParamReader { 
      ...
      public:
        ...
        /**
         * Reads all the lines from the file and stores them into this objectâ€™s
         ...
         * 1, 2, â€¦, k\f$. The \f$B_i, C_i\f$ must be given in the order \f$B_1,
         * C_1, B_2, C_2, â€¦, B_k, C_k\f$, each on a line of its own. Each

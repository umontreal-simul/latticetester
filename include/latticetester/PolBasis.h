...
>>>>>>> 0c2559aad798cd9b34adf3f5913f50e33afd5958
...
public:
    ...
    */
   PolBasis (int dim, int maxDim, NormType norm = SUPNORM);

   /** Erwan
    * Constructor. Builds a basis of actual dimension \f$d\f$,
    * and with norm `norm`.
    */
   PolBasis (int dim, NormType norm = SUPNORM);

   /**
    * Copy constructor.
    */
   PolBasis (const PolBasis &);
    ...
    * Assignment operator.
    */
   PolBasis & operator= (const PolBasis &);

   /**
    * Swaps this basis with the basis `b`.
    */
   void swap (PolBasis & b);
